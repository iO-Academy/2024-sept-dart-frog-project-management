...
<header class="p-3 bg-teal-50 flex justify-between">
    ...
    <div class="pr-3 flex">
        <a href=<?php echo "task.php?task=$taskIdLink"?> class="p-3 rounded-l-lg border-y border-l">🇬🇧</a>
        <a href=<?php echo "task_us.php?task=$taskIdLink"?> class="p-3 bg-slate-300 rounded-r-lg border-y border-r">🇺🇸</a>
    </div>
</header>
<main class="p-3">
